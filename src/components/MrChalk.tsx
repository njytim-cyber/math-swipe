            ...
            <AnimatePresence mode="wait">
                {message && (
                    <motion.div
                        ...
                        className="absolute bottom-full mb-2 right-0 max-w-[220px] text-right bg-[var(--color-surface)] border border-[rgb(var(--color-fg))]/15 rounded-xl px-3 py-1.5 text-[11px] ui text-[rgb(var(--color-fg))]/80 leading-snug line-clamp-3 overflow-hidden"
                    >
                        {message}
